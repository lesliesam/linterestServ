...
public class SmsApi {
    ...
    private static String apikey = "4ec01392893079501621b3f47492cc5c";

    public static void main(String[] args) throws IOException, URISyntaxException {

        //修改为您要发送的手机号
        String mobile = "13816631019";
        ...
        //sendPhoneBindingValidationCode(code, mobile);

        /**************** 使用接口发语音验证码 *****************/
        //System.out.println(SmsApi.sendVoice(apikey, mobile ,code));
    }

    public static String sendPhoneBindingValidationCode(String code, String phoneNumber) throws IOException {
        long tpl_id = 1207077;
        ...
        return SmsApi.tplSendSms(apikey, tpl_id, tpl_value, phoneNumber);
    }
